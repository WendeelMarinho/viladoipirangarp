...
widgets = {
    --{"nome",defaultX,defaultY,largura,altura,redimensionável,visível,ocultável,maxW,maxH,minW,minH}
    {},
}

defaultWidgets = {
    --{"nome",defaultX,defaultY,largura,altura,redimensionável,visível,ocultável,maxW,maxH,minW,minH,redimensionável2 (true = desativar)}
    ...
    {"Dados do jogador", 0.76,0.009,0.24, 0.125,true,true,true,0.5,0.193,0.05,0.193, 2},
    ...
    {"Painel de sirene", 0.41,0.8,0.17,0.09,false,true,true,0,0,0,0},
    ...
    --{"Dinheiro", 0.865, 0.09+0.02, 0.128, 0.03, false, true, true, 0.3, 0.3, 0.05, 0.06},
    --{"Pontos premium", 0.79, 0.09+0.02, 0.128, 0.03, false, false, true, 0.3, 0.3, 0.05, 0.06},
    {"Oxigênio", 0.7,0.01,0.04, 0.05, false, false, true, 0.3, 0.3, 0.05, 0.06},
    --{"Esqueleto", 0.782, 0.02, 0.0135, 0.056, false, true, true, 0.3, 0.3, 0.05, 0.06},
    --{"Casino Coin", 0.865, 0.12+0.02, 0.128, 0.03, false, false, true, 0.3, 0.3, 0.05, 0.06},

    --{"Piloto automático", 0.82, 0.68, 0.173, 0.03, false, true, true, 0.3, 0.3, 0.05, 0.06},
    {"Combustível", 0.795, 0.865, 0.0725, 0.135, false, true, true, 0, 0, 0, 0},
    ...
    --{"Comida/Bebida", 0.804,0.049,0.193, 0.025,true,true,true,0.5,0.013,0.05,0.013, 1, true},
    --{"Stamina", 0.804,0.069,0.193, 0.025,true,true,true,0.5,0.013,0.05,0.013, 1, true},
    {"Álcool", 0.73,0.01,0.04, 0.05,false,true,true,0.5,0.013,0.05,0.013, 1, true},
